...
U_MT_L(LGUI, A),   U_MT_L(LALT, S),   U_MT_L(LCTRL, D),  U_MT_L(LSHFT, F),  &kp G,             &kp H,             U_MT_R(LSHFT, J),  U_MT_R(LCTRL, K),  U_MT_R(LALT, L),   U_MT_R(LGUI, P),   \
...
&kp LS(NON_US_BACKSLASH), &kp EXCL,   &kp LS(SQT),       &kp LA(N3),        &kp LS(NON_US_HASH), U_NA,            &u_to_U_SYM,       &u_to_U_MOUSE,     &kp RALT,          U_NA,              \
